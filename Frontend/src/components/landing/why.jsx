...
const reasons = [
  ...
  },
  {
    title: "High Demand",
    description:
      "Blood is needed every 2 seconds for various medical procedures.",
    icon: Zap,
  },
  {
    title: "Be a Hero",
    description:
      "Less than 10% of eligible people donate blood yearly. Be part of this heroic group!",
    icon: Shield,
  },
  {
  ...
  },
  {
    ...
    description:
      "Regular blood donation can reduce iron levels and lower the risk of certain health issues.",
    icon: Stethoscope,
  },
  {
    title: "Free Health Screening",
    description:
      "Every time you donate, your blood is tested for various conditions, giving you insights into your health.",
    icon: CheckCircle,
  },
];
    ...
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Blood donation is a simple act that can make an extraordinary
          difference. Discover the incredible impact you can have by becoming a
          donor.
        </p>
      </div>
